...
## Generated on : Wed Mar 27 17:25:45 2024
...
START_DIR                 = C:/Users/ecmce/3MD4-Pacemaker
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
OBJS = MW_digitalIO.o mw_sdk_interface.o i2c_api.o MW_I2C.o MW_PWM.o Pacemaker.o Pacemaker_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
rtGetInf.o : $(START_DIR)/Pacemaker_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Pacemaker_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Pacemaker_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
