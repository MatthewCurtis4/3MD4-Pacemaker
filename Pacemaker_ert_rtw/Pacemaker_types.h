...
/* Custom Type definition for MATLABSystem: '<S2>/PWM Output2' */
#include "MW_SVD.h"
...
#ifndef typedef_c_freedomk64f_Hardware_Pacema_T
#define typedef_c_freedomk64f_Hardware_Pacema_T

typedef struct tag_0QIIqIWUIOhUbf1p9QN9pB c_freedomk64f_Hardware_Pacema_T;

#endif                             /* typedef_c_freedomk64f_Hardware_Pacema_T */
...
struct tag_O0UAiliRyLLAe38ibfdAhE
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  c_freedomk64f_Hardware_Pacema_T Hw;
  uint32_T BusSpeed;
...
#ifndef typedef_cell_wrap_Pacemaker_T
#define typedef_cell_wrap_Pacemaker_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_Pacemaker_T;

#endif                                 /* typedef_cell_wrap_Pacemaker_T */
...
struct tag_VOE7AtRllbxQ5W4Ai4wCw
{
  ...
  cell_wrap_Pacemaker_T inputVarSize;
